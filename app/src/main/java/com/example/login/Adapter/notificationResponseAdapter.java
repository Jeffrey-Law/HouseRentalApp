...
public class notificationResponseAdapter extends RecyclerView.Adapter<notificationResponseAdapter.ViewHolder> {
    Context context;
    List<Booking> list;

    int owner_id;
    public notificationResponseAdapter(Context context, List<Booking> list) {
    ...
    @NonNull
    @Override
    public notificationResponseAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.notification_choose, parent, false);

        notificationResponseAdapter.ViewHolder viewHolder = new notificationResponseAdapter.ViewHolder(itemView);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull notificationResponseAdapter.ViewHolder holder, int position) {
