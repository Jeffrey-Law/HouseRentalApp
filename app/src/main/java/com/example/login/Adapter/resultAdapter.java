...
public class resultAdapter extends RecyclerView.Adapter<resultAdapter.ViewHolder> {
    private final SearchResultInterface searchResultAdapter;
    Context context;
    List<House> list;

    public resultAdapter(Context context, List<House> list, SearchResultInterface hotHouseInterface) {
        this.searchResultAdapter = hotHouseInterface;
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, SearchResultInterface searchResultAdapter) {
            super(itemView);
                ...
                public void onClick(View v) {
                    if (searchResultAdapter != null) {
                        if (getAdapterPosition() != RecyclerView.NO_POSITION) {
                            ...
                            searchResultAdapter.onItemClickSearchResult(id);
                        }
                    }
                }
            });
